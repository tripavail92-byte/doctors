...
async function main() {
  ...
  const editionPrice: Record<string, { pkr: number; usd: number }> = {
    ...
    DERMATOLOGY: { pkr: 35000, usd: 125 },
    DENTAL: { pkr: 35000, usd: 125 },
    OBGYN: { pkr: 40000, usd: 140 },
    PEDIATRICS: { pkr: 35000, usd: 125 },
    OPHTHALMOLOGY: { pkr: 35000, usd: 125 },
    PHYSIOTHERAPY: { pkr: 30000, usd: 105 },
